...
BasicUdyamDetails.search = async (req, res) => {
  try {
    ...
    await saveLog(req.body.jwtInfo.jwtId, "Basic Udyam Details", responseTime, response.data.statusCode === 101 ? "success" : "failed", requestBody);
    ...
    // save data
    await KarzaBasicUdyamDetails.findOneAndUpdate({ entityId: requestBody.entityId }, data, { upsert: true, new: true });
    ...
    console.error("Error fetching basic udyam details:", error);
